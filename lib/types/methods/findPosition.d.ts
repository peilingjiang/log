...
export function _getPos(leftNum: any, topNum: any, rightNum: any, bottomNum: any, horizontalAlign: any, verticalAlign: any, registration: any): {
    left: string;
    top: string;
    right: string;
    bottom: string;
...
export function registeredPositions(posId: any, anchorBounding: any): {
    left: string;
    top: string;
    right: string;
    bottom: string;
