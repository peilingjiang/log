export default class LogHost extends React.Component<any, any, any> {
    ...
    _updateRegistries(asts: any, registries: any, logGroups: any, logTimeline: any): void;
    defineLogs(): void;
    ...
    renderTimelineLogs(logGroups: any, logTimeline: any, logPaused: any, asts: any, registries: any): false | JSX.Element;
    updateSyncGraphics(groupId: any): void;
