export const TimelineName: React.MemoExoticComponent<{
    ({ logPaused, timelineFolded, timelineGrabbing, timelineEnableArea, handleTimelineDragAround, handleTimelinePositionReset, handleTimelineArea, handleTimelineFold, hostFunctions, }: {
        logPaused: any;
        timelineFolded: any;
