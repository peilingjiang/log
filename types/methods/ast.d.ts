export function preprocessASTsToGetRegistries(
  logGroups: any,
  logTimeline: any,
  newASTs: any,
  prevRegistries: any
): {}
export function matchWebPathAndFilePath(
  webPath: any,
  filePath: any
): boolean | undefined
...
export function getTimelineOffsets(
  logGroups: any,
  registriesByFileName: any,
  budget: any,
  expandLevels: any
): {
  offsets: {}
...
export function getExtremeDepthsByTopLevelDeclarations(
  fileRegistry: any,
  targetDeclaration: any,
  toDoDeclarations: any
): {
  max: number
  min: number
}
export function _declarationExists(
  declarations: any,
  declarationName: any
): boolean
export function _getDeclarationFromAllDeclarations(
  declarations: any,
  declarationName: any
): any
...
export function _getDeclarationByGroupId(
  declarations: any,
  groupIdExtended: any
): any
